...
class TestState:
    ...
    def test_that_entity_is_marked_as_saved_after_successful_persistence(self, test_domain):
        person = Person(first_name='John', last_name='Doe')
        assert person.state_.is_new
    ...
    def test_that_a_new_entity_still_shows_as_new_if_persistence_failed(self, test_domain):
        person = Person(first_name='John', last_name='Doe')
        try:
    ...
    def test_that_a_changed_entity_still_shows_as_changed_if_persistence_failed(self, test_domain):
        person = test_domain.get_dao(Person).create(first_name='John', last_name='Doe')
    ...
    def test_that_entity_is_marked_as_not_new_after_successful_persistence(self, test_domain):
        person = test_domain.get_dao(Person).create(first_name='John', last_name='Doe')
        assert not person.state_.is_new

    def test_that_aggregate_copying_resets_state_in_the_new_aggregate_object(self, test_domain):
