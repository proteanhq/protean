...
class TestDeltaEvents:
    ...
    def test_event_metadata(self):
        ...
        assert user._events[0]._metadata.domain.version == 1
        ...
        assert user._events[1]._metadata.domain.version == 1
    ...
    def test_event_metadata_from_stream(self, test_domain):
        ...
        assert event_messages[0].metadata.domain.version == 1
        ...
        assert event_messages[1].metadata.domain.version == 1
