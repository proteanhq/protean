...
class TestEquivalence:
    ...
    def test_that_two_entities_with_same_id_are_treated_as_equal(self):
        ...
        assert role1 == role3  # Because it's the same record even though attributes differ
        assert role3 == role1
    ...
    def test_generated_aggregate_hash(self):
        ...
        role = Role(id=1, name='ADMIN')
        assert hashed_id == hash(role)  # FIXME Should hash be based on ID alone, or other attrs too?
