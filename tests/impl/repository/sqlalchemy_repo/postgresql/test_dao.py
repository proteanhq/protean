...
class TestDAO:
    ...
    def test_that_escaped_quotes_in_values_are_handled_properly(self, test_domain):
        ...
        test_domain.get_dao(Person).create(first_name='Porthos', last_name='Musketeer', age=3)
        test_domain.get_dao(Person).create(first_name='Aramis', last_name='Musketeer', age=4)
...
class TestDAODeleteFunctionality:
    ...
    def test_delete_an_object_in_repository_by_id(self, test_domain):
        ...
        identifier = uuid4()
        person = test_domain.get_dao(Person).create(id=identifier, first_name='John', last_name='Doe', age=22)
    ...
    def test_delete_all_records_in_repository(self, test_domain):
        ...
        test_domain.get_dao(Person).create(first_name='Porthos', last_name='Musketeer', age=3)
        test_domain.get_dao(Person).create(first_name='Aramis', last_name='Musketeer', age=4)
        test_domain.get_dao(Person).create(first_name='dArtagnan', last_name='Musketeer', age=5)
    ...
    def test_deleting_a_persisted_entity(self, test_domain):
        """ Delete an object in the reposoitory by ID"""
        identifier = uuid4()
        person = test_domain.get_dao(Person).create(id=identifier, first_name='Jim', last_name='Carrey')
        deleted_person = test_domain.get_dao(Person).delete(person)
        assert deleted_person is not None
        assert deleted_person.state_.is_destroyed is True
    ...
    def test_deleting_all_records_of_a_type_satisfying_a_filter(self, test_domain):
        ...
        identifier3 = uuid4()
        identifier4 = uuid4()
        test_domain.get_dao(Person).create(id=identifier1, first_name='Athos', last_name='Musketeer', age=2)
        test_domain.get_dao(Person).create(id=identifier2, first_name='Porthos', last_name='Musketeer', age=3)
        test_domain.get_dao(Person).create(id=identifier3, first_name='Aramis', last_name='Musketeer', age=4)
        test_domain.get_dao(Person).create(id=identifier4, first_name='d\'Artagnan', last_name='Musketeer', age=5)
...
class TestDAORetrievalFunctionality:
    ...
    def persisted_person(self, test_domain, identifier):
        person = test_domain.get_dao(Person).create(id=identifier, first_name='John', last_name='Doe')
        return person
    ...
    def test_entity_retrieval_by_its_primary_key(self, test_domain, identifier, persisted_person):
    ...
    def test_filter_initialization_of_query_from_entity(self, test_domain):
        filters = [
            ...
            test_domain.get_dao(Person).query.filter(first_name='Jean').filter(last_name='John'),
    ...
    def test_that_chaining_filters_returns_a_queryset_for_further_chaining(self, test_domain):
    ...
    def test_filter_by_chaining_example_1(self, test_domain):
        ...
        identifier2 = uuid4()
        identifier3 = uuid4()
        test_domain.get_dao(Person).create(id=identifier1, first_name='Murdock', age=7, last_name='John')
        test_domain.get_dao(Person).create(id=identifier2, first_name='Jean', age=3, last_name='John')
...
class TestDAOUpdateFunctionality:
    ...
    def test_that_updating_a_deleted_aggregate_raises_object_not_found_error(self, test_domain):
        """Try to update a non-existing entry"""

        person = test_domain.get_dao(Person).create(first_name='Johnny', last_name='John')
    ...
    def test_updating_record_with_dictionary_args(self, test_domain):
        ...
        identifier = uuid4()
        person = test_domain.get_dao(Person).create(id=identifier, first_name='Johnny', last_name='John', age=2)
    ...
    def test_updating_record_through_filter(self, test_domain):
        ...
        test_domain.get_dao(Person).create(id=identifier2, first_name='Porthos', last_name='Musketeer', age=3)
        test_domain.get_dao(Person).create(id=identifier3, first_name='Aramis', last_name='Musketeer', age=4)
        test_domain.get_dao(Person).create(id=identifier4, first_name='dArtagnan', last_name='Musketeer', age=5)

        # Perform update
        updated_count = test_domain.get_dao(Person).query.filter(age__gt=3).update(last_name='Fraud')
    ...
    def test_updating_multiple_records_through_filter_with_arg_value(self, test_domain):
        ...
        # Perform update
        updated_count = test_domain.get_dao(Person).query.filter(age__gt=3).update_all({'last_name': 'Fraud'})
...
class TestDAOValidations:
    ...
    def test_that_field_required_validations_are_triggered_on_incorrect_attribute_setting(self):
    ...
    def test_that_primitive_validations_on_type_are_thrown_correctly_on_initialization(self, test_domain):
        with pytest.raises(ValidationError) as error:
            Person(first_name='Johnny', last_name='John', age='x')

        assert error.value.messages == {'age': ['"x" value must be an integer.']}

    def test_that_primitive_validations_on_type_are_thrown_correctly_on_update(self, test_domain):
