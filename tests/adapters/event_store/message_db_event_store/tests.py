...
def test_reading_stream_message(test_domain):
    ...
    messages = test_domain.event_store.read("testStream-123")
...
def test_reading_category_message(test_domain):
    ...
    messages = test_domain.event_store.read("testStream")
...
def test_reading_targeted_stream_messages(test_domain):
    ...
    messages = test_domain.event_store.read("testStream-456")
