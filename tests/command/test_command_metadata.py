...
def test_command_metadata(test_domain):
    ...
    # correlation_id is auto-generated by _enrich_command — verify it's a non-empty hex string
    generated_correlation_id = command_dict["_metadata"]["domain"]["correlation_id"]
