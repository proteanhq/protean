...
class HasOneHuman1:
    ...
    last_name = String(required=True, unique=True, max_length=50)
    email = String(required=True, unique=True, max_length=50)
    dog = HasOne('tests.old.support.dog.HasOneDog1')
...
class HasOneHuman2:
    ...
    last_name = String(required=True, unique=True, max_length=50)
    email = String(required=True, unique=True, max_length=50)
    dog = HasOne('tests.old.support.dog.HasOneDog2', via='human_id')
...
class HasOneHuman3:
    ...
    last_name = String(required=True, unique=True, max_length=50)
    email = String(required=True, unique=True, max_length=50)
    dog = HasOne('tests.old.support.dog.HasOneDog3', via='human_id')
...
class HasManyHuman1:
    ...
    last_name = String(required=True, unique=True, max_length=50)
    email = String(required=True, unique=True, max_length=50)
    dogs = HasMany('tests.old.support.dog.HasManyDog1')
...
class HasManyHuman3:
    ...
    last_name = String(required=True, unique=True, max_length=50)
    email = String(required=True, unique=True, max_length=50)
    dogs = HasMany('tests.old.support.dog.HasManyDog3', via='human_id')
