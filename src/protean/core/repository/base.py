...
class BaseRepository(metaclass=ABCMeta):
    ...
    def create(self, *args, **kwargs) -> 'BaseEntity':
        ...
        model_cls = repo_factory.get_model(self.entity_cls)
        repository = repo_factory.get_repository(self.entity_cls)
        ...
        try:
            ...
            model_obj = repository._create(model_cls.from_entity(entity_obj))
    ...
    def update(self, entity_obj, *data, **kwargs) -> 'BaseEntity':
        ...
        try:
            ...
            repository._update(model_cls.from_entity(entity_obj))
    ...
    def delete(self, entity_obj):
        ...
        try:
            if not entity_obj.state_.is_destroyed:
                # Update entity's data attributes
                repository._delete(model_cls.from_entity(entity_obj))
