...
- [Event Sourcing](./event-sourcing.md) -- the architectural pattern that uses streams as the primary persistence mechanism
- [Stream Categories Guide](../guides/essentials/stream-categories.md) -- configuring and working with stream categories in Protean
- [Events](./domain-elements/events.md) -- the messages that streams contain
