...
- [Aggregates](./domain-elements/aggregates.md) -- identity as the aggregate root's distinguishing property
- [Value Objects](./domain-elements/value-objects.md) -- the identity-less counterpart
- [Identity Guide](../guides/essentials/identity.md) -- Protean-specific identity configuration and strategies
