...
- [`protean dx`](./reference/cli/project/dx.md): Write and maintain a project's agent-facing files (AGENTS.md, the CLAUDE.md bridge, `.mcp.json`, and the per-editor files for Cursor, Copilot, and opencode), version-coupled to the installed framework.
