...
=== "PostgreSQL"
    ...
    ALTER TABLE outbox
      ...
      ALTER COLUMN causation_id TYPE varchar(64),
      ALTER COLUMN message_id TYPE varchar(64);
    ```
...
=== "MySQL"
    ...
    ALTER TABLE outbox
      ...
      MODIFY correlation_id varchar(64) NULL,
      MODIFY causation_id varchar(64) NULL,
...
=== "SQL Server"
    ...
    ALTER TABLE outbox ALTER COLUMN correlation_id varchar(64) NULL;
    ALTER TABLE outbox ALTER COLUMN causation_id varchar(64) NULL;
    ALTER TABLE outbox ALTER COLUMN message_id varchar(64) NOT NULL;
    ```
