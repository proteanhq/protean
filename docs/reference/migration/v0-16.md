...
behavioral changes described below. Run `protean upgrade-check --domain=<your
domain>` to have these surfaced for your project, with the generated outbox
`ALTER` SQL where applicable.
...
`PROTEAN_ENV=development` or `testing`. See
