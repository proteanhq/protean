...
| [`protean verify`](verify.md)          | Init + check + tests in one command, with one verdict |
...
| [`protean dx install`](project/dx.md)   | Write a project's agent-facing files (AGENTS.md, the CLAUDE.md bridge, `.mcp.json`, and the per-editor files) |
