...
| Track created/updated timestamps and audit users (`created_by`/`updated_by`) | [Track Audit and Lifecycle Fields](./patterns/track-audit-fields.md) |
...
| Install agent instructions into a project       | [`protean dx`](./reference/cli/project/dx.md) |
...
| Check event-store integrity                     | [`protean eventstore verify`](./reference/cli/data/eventstore.md) |
