...
Subscriptions connect handlers to **[stream categories](../essentials/stream-categories.md)**, which are logical groupings of related messages (events and commands). Stream categories determine how messages are organized and routed from message sources (event stores, brokers) to handlers.
...
For comprehensive details on stream categories, including message organization, routing patterns, event sourcing, and best practices, see the [Stream Categories](../essentials/stream-categories.md) guide.
...
- [Subscription Types](subscription-types.md) - Deep dive into StreamSubscription
  vs EventStoreSubscription
- [Configuration](configuration.md) - Configure subscriptions with profiles and
  options
