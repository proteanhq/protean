# Priority Lanes -- Prioritized Event Processing
...
- [Running Migrations Without Blocking Production](running-migration-with-priority-lanes.md) --
...
- [Outbox Pattern](server/outbox.md) -- How the outbox ensures reliable
  message delivery.
- [Subscription Types](server/subscription-types.md) -- How `StreamSubscription`
  consumes messages from Redis Streams.
- [Configuration](server/configuration.md) -- Full configuration reference for
